...
public class HoloLoungeServiceTests {
    ...
    public void testRegister() {
        ...
        holoLoungeDTO.setCategoryNo(1L);
    ...
    private void printHoloLoung(HoloLoungeDTO holoLoungeDTO) {
        log.info("게시물: {} {} {} {} {} {} {} {}",
    ...
    public void testModify() {
        ...
        holoLoungeDTO.setCategoryNo(3L);
    ...
    public void testList() {
        ...
        pageResponseDTO.getDtoList().forEach(this::printHoloLoung);
    }
}
